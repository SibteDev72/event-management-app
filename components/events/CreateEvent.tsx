...
const CreateEvent = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // // console.log("Saved EventDetails:", formData);
  ...
  return (
    <div className="px-4 sm:px-6 md:px-12 py-6">
      <form
        ...
        className="w-full mt-4 flex flex-col gap-10"
      >
        {/* Event Details */}
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <DropdownForm
              ...
              values={["sports", "festival", "general", "music"]}
        ...
        <button
          type="submit"
          className="self-end bg-[#2B293D] max-w-max rounded-md px-6 py-2 text-sm text-white"
        >
          Save & Preview
        </button>
      </form>
